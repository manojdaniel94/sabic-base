...
const ReliablityHeatMap = ({ statusData }: Props) => {
    return (
            ...
            <div className="pmt-heatmapvalues">
                <div className="hi-value1">
                    <span className="hi-numbers">
                        ...
                        {statusData && statusData.assetOff}</span><span className="hi-name">Asset-Off</span><span className="hi-status">Off</span></div>
                <div className="hi-value2">
                    <span className="hi-numbers">
                        ...
                        </div> {statusData && statusData.warning}</span><span className="hi-name">Normal</span><span className="hi-status">Health Index &gt; 70%</span></div>
                <div className="hi-value3"><span className="hi-numbers">
                    ...
                    </div>  {statusData && statusData.normal}</span><span className="hi-name">Warning</span><span className="hi-status">Health Index &lt; 70%</span></div>
                <div className="hi-value4"><span className="hi-numbers">
                    ...
                    </div>  {statusData && statusData.normal}</span><span className="hi-name">Asset Under Risk</span><span className="hi-status">Health Index Under Risk</span></div>
            </div>
