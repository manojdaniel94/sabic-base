...
export const Api = {
    ...
    getApiAssetStatusListbyPlantId: BASE_URL + 'DeviationPlot/getdeviationplotgraph_byassetid/',
    getApiHeatMapToolTipbyAssetStatus: BASE_URL + 'DeviationPlot/getdeviationplotgraph_byassetid/',
    getApiTopBarToolTipbyPlantId: BASE_URL + 'DeviationPlot/getdeviationplotgraph_byassetid/',
